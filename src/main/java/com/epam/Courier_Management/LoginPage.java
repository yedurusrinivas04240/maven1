package com.epam.Courier_Management;
import javax.swing.*;
import java.awt.*;
...
public class LoginPage extends JFrame implements ActionListener, ItemListener, MouseListener {
    ...
    LoginPage() {
        ...
        //background
        ImageIcon bimg = new ImageIcon("/Courier-Management/src/main/java/images/home_page_background.jpg");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == lb) {
            if (userName.getText().trim().isEmpty() && password.getText().trim().isEmpty())
                ...
                String q1;
                if (i==0){
                    q1 = "select * from UserLoginDetails where username = '" + userName.getText()
                            + "' and passwrd = '" + password.getText() +"';";
                } else {
